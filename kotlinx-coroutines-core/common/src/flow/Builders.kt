 ...
 *
 * A channel with [default][Channel.DEFAULT] buffer size is used. Use [buffer] operator on the
 ...
 *             // Use either conflate() or buffer(Channel.UNLIMITED) to avoid overfill
 *             offer(value)
 *         }
